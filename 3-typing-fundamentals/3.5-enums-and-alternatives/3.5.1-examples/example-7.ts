...
let valueOfRedName1 = ColorNames[redName];
let valueOfRedName2 = ColorNames["Red"]; // Error: Property 'red' does not exist on type 'typeof ColorNames'. Did you mean 'Red'?
console.log(valueOfRedName1);
console.log(valueOfRedName2);
